  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}> 
        ...
        <button type="submit" className="mb-6 w-full px-7 py-3 bg-black text-white font-medium text-sm uppercase rounded shadow-md hover:opacity-70 hover:shadow-lg focus:bg-black focus:shadow-lg active:bg-black active:shadow-lg transition duration-150 ease-in-out">Edit Listing</button>
      </form>
    </main>
  );
}
